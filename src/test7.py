...
with tf.Session() as sess:
    ...
    # saver.restore(sess, 'D:/workspace/cuijingwen/stage3_2/ParamofFig3/close/256/1/save_net.ckpt')
    # saver.restore(sess, 'D:/workspace/cuijingwen/stage3_2/ParamofFig3/away/256/test/v01/save_net.ckpt')
    ##################### train
    ...
    # save_path = saver.save(sess, 'D:/workspace/cuijingwen/stage3_2/ParamofFig3/away/256/test/v01/save_net.ckpt')
    ...
    # print(np.shape(rr))
    np.savetxt('reliabilityyuan2/256/test/'+str(N)+'s'+str(SNR_db)+'e'+str(epoch)+'step00.txt', rr)
