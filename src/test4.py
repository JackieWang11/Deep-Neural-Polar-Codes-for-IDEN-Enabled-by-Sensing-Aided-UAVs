...
with tf.Session() as sess:
    ...
    # saver.restore(sess, 'D:/workspace/cuijingwen/stage3_2/ParamofFig3/away/256/test/v0/save_net.ckpt')
    # saver.restore(sess, 'D:/workspace/cuijingwen/stage3_2/ParamofFig3/away/2562/2/save_net.ckpt')
    ##################### train
    ...
    # save_path = saver.save(sess, 'D:/workspace/cuijingwen/stage3_2/ParamofFig3/away/256/test/v0/save_net.ckpt')
    ...
    # print(np.shape(rr))
    # np.savetxt('reliabilityyuan2/256/test/'+str(N)+'s'+str(SNR_db)+'e'+str(epoch)+'step300.txt', rr)
    np.savetxt('D:/workspace/cuijingwen/stage3_2/newnormwayforscatter/away/'+str(N)+'s'+str(SNR_db)+'e'+str(epoch)+'step200.txt', rr)
