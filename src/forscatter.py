...
llr_froz_vec=tf.Variable((np.float32(ffro)*0.1))#tf.Variable((np.float32(ffro))*0.1)  #tf.Variable((np.float32(ffro)-0.5))
...
with tf.Session() as sess:
    ...
    # saver.restore(sess,  'D:/workspace/cuijingwen/stage3_2/reliabilitykao/256/param12/save_net.ckpt')
    ##################### train
    ...
    # #
    # #
    # save_path = saver.save(sess, 'D:/workspace/cuijingwen/stage3_2/reliabilitykao/256/param14/save_net.ckpt')
