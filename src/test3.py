...
####################
# init=np.loadtxt('D:/workspace/cuijingwen/stage3_2/reliabilityyuan2/64/' + str(N) + 's' + str(SNR_db) + 'e' + str(epoch) + '.txt')
...
with tf.Session() as sess:
    ...
    # saver.restore(sess, 'D:/workspace/cuijingwen/stage3_2/ParamofFig3/away/1282/1/save_net.ckpt')
    ##################### train
    ...
    # # #
    # # # #
    # save_path = saver.save(sess, 'D:/workspace/cuijingwen/stage3_2/ParamofFig3/close/1282/4/save_net.ckpt')
    ...
    # print(np.shape(rr))
    # np.savetxt('reliabilityyuan2/1282/'+str(N)+'s'+str(SNR_db)+'e'+str(epoch)+'step500.txt', rr)
